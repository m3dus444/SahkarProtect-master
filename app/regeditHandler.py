...
wreg.SetValue(key, 'NewSubkey', wreg.REG_SZ, 'subkey_changed')  # change key folder
print(wreg.QueryValue(key, 'NewSubkey'))
# prints 'subkey_changed'
wreg.SetValueEx(key, 'ValueName', 0, wreg.REG_SZ, 'value_changed')  # change value of var in the subkey/key
print(wreg.QueryValueEx(key, 'ValueName'))
key.Close()
